...
const placeInput = document.getElementById("address");
const GOOGLE_API_KEY = "AIzaSyC271AmNs0DYhqBENykSyz5wvbr_jdRqbI";
function searchPlaceHandler(event) {
